// Outlook content script for SpamShield

function extractEmailData() {
  const subjectElement = document.querySelector('.ms-MessageHeader-subject h1') || document.querySelector('[data-qa="email-header-subject"]');
  const bodyElement = document.querySelector('.ms-MessageBody-body') || document.querySelector('[data-qa="email-body"]');
...
const observer = new MutationObserver(() => {
  const subject = document.querySelector('.ms-MessageHeader-subject h1') || document.querySelector('[data-qa="email-header-subject"]');
  if (subject) {
    addSpamCheckButton();
  }
});
